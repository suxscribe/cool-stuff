class RangeSlider {
  ...
  init() {
    document.documentElement.style.setProperty('--range-value', '0deg');
    this.bindEvents();
  }
  ...
  updateSlider(clientX) {
    ...
    document.documentElement.style.setProperty('--range-value', `${percentage * 3.6}deg`);
    document.documentElement.style.setProperty('--range-scale', percentage / 100);
